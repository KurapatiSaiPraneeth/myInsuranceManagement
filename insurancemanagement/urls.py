...
urlpatterns = [
    ...
    path('claim-dashboard', views.claim_dashboard_view,name='claim-dashboard'),
    path('admin-total_claim', views.total_claims,name='admin-total_claim'),
    path('approve-claim-request/<int:pk>', views.approve_claim_request_view,name='approve-claim-request'),
    path('reject-claim-request/<int:pk>', views.disapprove_claim_request_view,name='reject-claim-request'),
    path('admin-view-approved-claim', views.admin_view_approved_claim,name='admin-view-approved-claim'),
    path('admin-view-disapproved-claim', views.admin_view_disapproved_claim,name='admin-view-disapproved-claim'),
    path('admin-view-pending-claim', views.admin_view_pending_claims,name='/admin-view-pending-claim'),
